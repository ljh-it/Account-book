...
public class ChartUtil {
	...
	private static String[] sampleLabels(List<expend> rs) {
    ...
    public static double[] sampleValues(List<expend> rs) {
    ...
    public static Image getImage(List<expend> rs, int width, int height) {
        // 根据消费记录得到的样本数据
