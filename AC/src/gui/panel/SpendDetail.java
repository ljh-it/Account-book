...
import Services.expendService;
import gui.page.DetailPage;
import util.CircleProgressBar;
import util.ColorUtil;
import util.GUIUtil;

public class SpendDetail extends WorkingPanel {
    public static SpendDetail instance = new SpendDetail();
    ...
    public SpendDetail() {
        ...
        setColor(ColorUtil.blackColor, lMonthSpend, lTodaySpend, lAvgSpendPerDay, lMonthLeft, lDayAvgAvailable,
    ...
    public static void main(String args[]){
    	 GUIUtil.showPanel(SpendDetail.instance);
    }
	...
	public void updateData() {
		// TODO Auto-generated method stub
		    ...
		    spend = new expendService().getSpendPage();
